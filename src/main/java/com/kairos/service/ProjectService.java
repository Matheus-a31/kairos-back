...
public class ProjectService {
    ...
    @Transactional(readOnly = true)
    public Page<com.kairos.dto.ProjectMemberResponse> getProjectMembers(Long projectId, Pageable pageable) {
    ...
    @Transactional
    public com.kairos.dto.ProjectMemberResponse addMember(Long projectId, com.kairos.dto.AddMemberRequest request) {
        Project project = projectRepository.findById(projectId)
                .orElseThrow(() -> new ResourceNotFoundException("Projeto não encontrado"));
