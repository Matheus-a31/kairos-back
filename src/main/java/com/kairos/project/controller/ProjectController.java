...
public class ProjectController {
    ...
    public ResponseEntity<Page<com.kairos.project.dto.ProjectMemberResponse>> getProjectMembers(
            @PathVariable Long id,
    ...
    @PreAuthorize("@projectSecurity.isManager(authentication, #id)")
    public ResponseEntity<com.kairos.project.dto.ProjectMemberResponse> addMember(
            @PathVariable Long id,
            @Valid @RequestBody com.kairos.project.dto.AddMemberRequest request) {
